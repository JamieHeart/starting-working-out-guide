...
> **🏳️‍⚧️ HRT Users**: If you're on MTF hormone replacement therapy, see our [MTF HRT Considerations](hrt-mtf-considerations.md) guide for specific information about hormone-related weight patterns.
...
- **HRT users**: May experience larger fluctuations (2-6 pounds daily) due to hormone cycles
...
- **Hormonal fluctuations**: Estrogen levels significantly affect water retention patterns
...
- **MTF HRT cycles**: 4-day injection cycles can cause 2-4 pound fluctuations
...
- **HRT considerations**: Those on MTF HRT may see additional fluctuations from hormone cycles
...
- **HRT impact**: Those on MTF HRT may see slower muscle gains but still experience water retention patterns
...
### MTF HRT and Weight Patterns
- **Injection cycles**: 4-day cycles create predictable weight fluctuation patterns
- **Post-injection**: 1-3 pound increase from water retention (days 1-2)
- **Mid-cycle**: Stabilization around day 3
- **Pre-injection**: Often lowest weight point (day 4)
- **Best weigh-in day**: Day 4 pre-injection for most consistent readings

### Long-term HRT Effects
- **Body composition shifts**: Gradual changes in muscle and fat distribution
- **Metabolism changes**: 5-10% decrease in metabolic rate typical
- **Water sensitivity**: Increased sensitivity to sodium and hormonal water retention
...
3. **Context matters**:
   ...
   - **For HRT users**: Track injection dates and cycle patterns
...
- Loss of menstrual cycle in women (or disrupted HRT patterns)
...
### HRT-Specific Concerns
- **Extreme fluctuations**: Beyond normal 2-4 pound cycle range
- **Pattern disruption**: Sudden changes in typical cycle patterns
- **Concerning symptoms**: Severe mood changes, unusual swelling, or pain
...
- **For HRT users**: Accept that fluctuations may be more pronounced
...
- **HRT-specific**: Focus on day 4 of injection cycle for most consistent readings
...
### Scenario 4: MTF HRT Injection Cycle Pattern
**Day 1 (post-injection)**: 165 pounds
**Day 2**: 167 pounds (+2 pounds)
**Day 3**: 166 pounds (-1 pound)
**Day 4 (pre-injection)**: 164 pounds (-3 pounds from peak)
**Explanation**: Normal estrogen cycle affecting water retention
**Action**: Track patterns and use day 4 weights for progress monitoring
